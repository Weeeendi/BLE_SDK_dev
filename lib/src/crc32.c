...
/**
 * @brief calculate crc16 of ota
 * 
 * @param crcVal initialized crc value
 * @param pCh need calculate crc16 data
 * @param len 
 * @return uint16_t 
 */
...
/* =========================================================================
* This function can be used by asm versions of crc32()????????asm?crc32???
*/
