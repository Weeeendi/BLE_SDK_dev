...
#define YEAR_BASE 2000  //RTC record  year only have information of year




/**
 * @description: rtc to unix time to Beijing time
...
/**
 * @description:  rtc time convert to unix time
 ...
 * @param LocalTime 
 */
int set_rtc_time(rtc_time_t LocalTime);
